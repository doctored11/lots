...
// --- обилка перца: 2 перца выжигают ВСЮ линию, остальные дают ТОЛЬКО бонус как за два ---
// reel [chili, grape], комбинация [chili, chili, grape] → виноград как за два: +0.3, база сгорела
eq(
  "перец x2: виноград только +0.3 (база выжжена)",
  evaluateSpin(10, ["chili", "chili", "grape"], ["chili", "grape"], [0, 0, 1]).win,
  Math.floor(10 * 0.3) // 3
);

// ставка 110, 2 перца + 1 звезда: база звезды (×1.2) выжжена, остаётся +2 → 220
eq(
  "2 перца + звезда при ставке 110 → 220 (без ×1.2 звезды)",
  evaluateSpin(110, ["chili", "chili", "star"], ["chili", "star"], [0, 0, 1]).win,
  220
);
